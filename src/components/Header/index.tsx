...
export function Header() {
    const [documentName, setDocumentName ] = useState('sem_nome.md')

    return (
        <header className={style.header}>
            <div className={style.header__top}>
                <h2>MARKDOW</h2>
                <p>Criado por <a href="https://luisnunes.me">Luis Felipe</a></p>
                <div>
                    <button className={style.header__top_btnlogin}>Login</button>
                    <button className={style.header__top_btnsigin}>Cadastrar-se</button>
                </div>
            </div>
